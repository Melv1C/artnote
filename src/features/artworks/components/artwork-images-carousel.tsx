...
export const ArtworkImagesCarousel = forwardRef<HTMLElement, ArtworkImagesCarouselProps>(
  function ArtworkImagesCarousel({ artwork }, ref) {
    ...
    return (
      <section ref={ref as React.Ref<HTMLElement>} className="relative w-full">
        <Carousel
          className="w-full"
          opts={{
            align: 'start',
